...
function increaseCount(a, b, id) {
  ...
  if (value == 0) {
    ...
    document.getElementsByClassName("overlay-num")[0].innerHTML =
      countQuantity();
  }
}
  ...
  dataPhone
    ...
    .then(function (result) {
      ...
      for (var i = 0; i < myCart.arr.length; i++) {
        getEle(`input-quantity-${myCart.arr[i].phoneItem.id}`).value =
          myCart.arr[i].quantity;
      }
